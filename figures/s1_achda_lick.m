%% Extract recordings
good_rew = [10:16,20,22:26,28:29,40:42,44:46];
...
subplot(1,2,1); sm = 10;
shadederrbar(peth.time, movmean(nanmean(lick_an_avg,2),sm), movmean(SEM(lick_an_avg,2),sm), 'k');
...
% [a,b] = sort(m);
b = randperm(10,10);
h = heatmap(movmean(lick_an_avg(:,b)',10,2));
