%% v3
% Difference between ach_fft_v2 and ach_fft_v3:
% This script processes photometry data using FFT and applies adjustment
% where average FFT output is 
...
beh = raw_gfp;  d = 2; c{d} = 'GFP'; a{d} = [{beh.rec}; {beh.fp_prc1}]';
